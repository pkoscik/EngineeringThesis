...
% I'd go with the ability, but not sure
...
% Unless your bibliography says otherwise, I feel it's usually singular, so "chain has"
...
% Do you mean "translation blocks caching" without a comma?
...
% "of a greatly complicated codebase" or just "of a more complex codebase"
of greatly 
...
% I kinda disagree. Translation requires a translator?
%
% I'd say that it requires to be ran in an environment that allows to execute generated code
